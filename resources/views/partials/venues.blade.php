...
<div class="venue">
	...
	<div class="description col-xs-12 col-sm-6">
		...
		<div class="vDescription col-sm-4  col-xs-12">
			<div>
				<h3>Tarifas flexibles</h3>
				<span class="label label-default">{{$venue['prices']['hour']}}€ / hora</span>
				<span class="label label-default">{{$venue['prices']['halfday']}}€ / medio día</span>
				<span class="label label-default">{{$venue['prices']['day']}}€ / día</span> 
			</div>
			<div>
				<h3>Bonos de tiempo</h3>
				<span class="label label-primary">{{$venue['bono']}}</span>
			</div>
			@if($venue['id']  == 'beeSting')
			<div>
				<h3>Plano</h3>
				<span style="font-size: 16px" class="fa fa-file-pdf-o"></span> <a href="{{asset('assets/pdf/beeSting.pdf')}}" target="_blank">Conferencia/Aula</a>
			</div>
			@endif
		...
		<a href="espacios/{{$venue['id']}}" class="btn btn-primary btn-block btn-lg col-xs-12">Solicitar Reserva <i class="fa fa-chevron-right"></i></a>
