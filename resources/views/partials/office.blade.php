...
<div class="venue">
	...
	<div class="description col-xs-12 col-sm-6">
		...
		<div class="vDescription col-sm-4  col-xs-12">
			...
			<div>
				<h3>De Lunes a Viernes<br>De 9:00 a 19:00h</h3>
				<span class="label label-default">{{$venue['prices']['fulltime']}} / mes</span>
			</div>
			<div>
				<h3>Residente acceso 24/7</h3>
				<span class="label label-primary">{{$venue['prices']['24h']}} / mes</span>
			</div>
